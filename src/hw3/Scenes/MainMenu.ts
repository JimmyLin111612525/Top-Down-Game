...
export default class MainMenu extends Scene {
    ...
    startScene() {
        ...
        const text1 = "This game was created by Jimmy Lin, Joe Weaver, and Richard McKenna";
        ...
        */
        ...
        const wasdText = "WASD to move";
        const qText = "Q to drop an item";
        const eText = "E to pick up an item";
        const clickText = 'Click to use current item';
        const numText = '1&2 to change items';

        const controls1 = <Label>this.add.uiElement(UIElementType.LABEL, "controls", { position: new Vec2(center.x, center.y - 100), text: wasdText });
        const controls2 = <Label>this.add.uiElement(UIElementType.LABEL, "controls", { position: new Vec2(center.x, center.y - 50), text: qText });
        const controls3 = <Label>this.add.uiElement(UIElementType.LABEL, "controls", { position: new Vec2(center.x, center.y), text: eText });
        const controls4 = <Label>this.add.uiElement(UIElementType.LABEL, "controls", { position: new Vec2(center.x, center.y + 50), text: clickText });
        const controls5 = <Label>this.add.uiElement(UIElementType.LABEL, "controls", { position: new Vec2(center.x, center.y + 100), text: numText });

        controls1.textColor = Color.WHITE;
        controls2.textColor = Color.WHITE;
        controls3.textColor = Color.WHITE;
        controls4.textColor = Color.WHITE;
        controls5.textColor = Color.WHITE;
